    ...
    if (isset($_POST['submit'])) {
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if ($setting_pengguna) {
                ...
                header("Location:../../index.php?page=guru&pengguna=berhasil");
            }
            else {
                mysqli_query($kon,"ROLLBACK");
                header("Location:../../index.php?page=guru&pengguna=gagal");
            }
        }  
    }
?>

<form action="apps/guru/pengguna.php" method="post">
<?php
    include '../../config/database.php';
    $kode_pengguna=$_POST['kode_guru'];
    ...
    <div class="row">
        <div class="col-sm-7">
            <div class="form-group">
                <input name="kode_guru" type="hidden" id="kode_guru" class="form-control" value="<?php echo $_POST['kode_guru'];?>"/>
            </div>
        </div>
    </div>
    <div class="row">
