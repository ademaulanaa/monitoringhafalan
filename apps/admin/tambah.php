<?php
    ...
    if (isset($_POST['tambah_admin'])) {
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sql="INSERT INTO tbl_user (kode_pengguna, username, password, level) VALUES ('$kode_admin', '$username', '$password', '$level')";
...
<form action="apps/admin/tambah.php" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-sm-4">
            <button type="submit" name="tambah_admin" id="Submit" class="btn btn-success"><i class="fa fa-plus"></i>Tambah</button>
