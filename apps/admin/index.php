                            ...
                            <tbody>
                                ...
                                while ($data = mysqli_fetch_array($hasil)):
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-nowrap"><?php echo $data['nip']; ?></td>
                                        <td class="align-middle text-nowrap"><?php echo $data['nama']; ?></td>
                                        <td class="align-middle text-nowrap"><?php echo $data['email']; ?></td>
                                        <td class="text-center align-middle">
                                            
                                            <button id_admin="<?php echo $data['id_admin'];?>" class="tombol_edit btn btn-warning btn-sm"><i class="fa fa-edit"></i></button>
                                            <a href="apps/admin/hapus.php?id_admin=<?php echo $data['id_admin']; ?>&kode_admin=<?php echo $data['kode_admin']; ?>" class="btn-hapus-admin btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
                            </tbody>
...
<script>
   ...
   $('.btn-hapus-admin').on('click',function(){
    ...
    // Edit pengguna
    $('.tombol_edit_pengguna').on('click',function(){
        var id_user = $(this).attr("id_user");
        $.ajax({
            url: 'apps/admin/edit_pengguna.php',
            method: 'get',
    ...
    $('.tombol_ubah_password').on('click',function(){
        var id_user = $(this).attr("id_user");
        $.ajax({
            url: 'apps/admin/ubah_password.php',
            method: 'get',
            data: {id_user:id_user},
            success:function(data){
                $('#tampil_data').html(data);  
